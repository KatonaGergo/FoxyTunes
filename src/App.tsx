  ...
  return (
    <div className="main-bg">
      ...
      >
        ...
        <button className="get-started" onClick={() => handleNavClick("about")}>
          About the app
        </button>
      </motion.nav>
      <section className="hero" ref={heroRef}>
        ...
        >
          ...
          >
            ...
            <p className="subtext">
              Welcome to Foxytunes! A space where voices meet, melodies travel,
              and hearts listen. Made for moments we cant put into words. Share
              songs, send love, and stay close, even when miles apart. This
              world was crafted with you in mind, Kaysha. 💜
            </p>
            <motion.button
      ...
      <section ref={messageRef} className="section message-section">
        <motion.div
          ...
          onMouseMove={(e: React.MouseEvent<HTMLDivElement, MouseEvent>) =>
            handleCardMouseMove(e, setMsgCardRotation)
          }
          onMouseLeave={() => handleCardMouseLeave(setMsgCardRotation)}
        >
          <h2>A Message For You</h2>
          <p>
            Behind this button is a hidden gift, <br /> where time slows, music
            flows, <br /> and a birthday wish softly blooms. <br /> Tap to open
            it, its all for you. 🎂🌸
          </p>
          <a
            href="https://birthday-q74i.onrender.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Click me!
      ...
      <section ref={aboutRef} className="section about-section">
        <motion.div
          ...
          style={{ perspective: 900 }}
          animate={{
            rotateX: aboutCardRotation.x,
            rotateY: aboutCardRotation.y,
          }}
          transition={{
            type: "spring",
            stiffness: 180,
          ...
          onMouseMove={(e: React.MouseEvent<HTMLDivElement, MouseEvent>) =>
            handleCardMouseMove(e, setAboutCardRotation)
          }
          onMouseLeave={() => handleCardMouseLeave(setAboutCardRotation)}
        >
          <h2>About the app</h2>
          <p>
            FoxyTunes is more than an app, its a cozy space for us to share
            music, laugh, talk, and feel close no matter where we are. Built for
            connection. Designed with love. 💜 (More details coming soon!){" "}
          </p>
        </motion.div>
      </section>
    </div>
